...
export function MonthlyBar({ data }: { data: { month: string; expense: number }[] }) {
  ...
  return <View style={[styles.card, { backgroundColor: colors.surface }]}><BarChart data={chart} barWidth={18} spacing={12} roundedTop hideRules yAxisThickness={0} xAxisThickness={0} xAxisLabelTextStyle={{ color: colors.secondaryText }} yAxisTextStyle={{ color: colors.secondaryText }} /></View>;
}
